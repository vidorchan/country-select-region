...
<body>
	<select class="crs-country" data-region-id="two"
		data-default-option="Select a country, man.">
		<option value="">Select a country, man.</option>
	...
	<br>
	<select id="two"
		data-blank-option="No country selected, mon. (blank value)"
		data-default-option="Select a region, pal. (default option)"><option
			value="">Select a region, pal. (default option)</option>
		...
		<option value="Xizang (Tibet)">Xizang (Tibet)</option>
